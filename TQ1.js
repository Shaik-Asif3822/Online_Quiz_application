...
const quizData = [
  ...
  {
    question: '2. What is the output of print(type([1,2,3])) in Python?',
    options: ['<class set>', '<class list>', '<class tuple>', '<class dict>'],
    answer: '<class list>',
  },
  {
    question: '3. Which of the following is a dynamically typed programming language?',
    options: ['Java', 'C++', 'Python', 'C'],
    answer: 'Python',
  },
  {
    question: '4. Which function is used to find the length of a list in Python?',
    options: ['count()', 'len()', ' length()', 'size()'],
    answer: 'len()',
  },
  {
    question: '5. In Java, which of these is not a keyword?',
    options: ['null', 'instanceof', 'sizeof', 'default'],
    answer: 'sizeof',
  },
...
function displayResult() {
  ...
  resultContainer.innerHTML =
    ...
    score>=3 ?`You scored ${score} out of ${quizData.length}! and eligible for level2 <br><a href="TQ2.html">Go for L2</a>`:(  `You scored ${score} out of ${quizData.length}!`);
...
function showAnswer() {
  ...
  // incorrectAnswersHtml+=`<br><button class="button"><a class="anchor" href="TQ2.html">Next Level</a></button>`
